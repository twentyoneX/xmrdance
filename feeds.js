...
function get_marketplaces() {
  ...
  marketplaces.push({'name': 'twitter_monero', 'feed': 'https://nitter.poast.org/monero/rss', 'format': 'rss'}); // UPDATED Nitter link
  marketplaces.push({'name': 'telegram_monero_market', 'feed': 'https://nitter.poast.org/monero_market/rss', 'format': 'rss'}); // UPDATED Nitter link
