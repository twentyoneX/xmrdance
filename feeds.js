...
function get_marketplaces() {
  return [
    ...
    // UPDATED: Using the LocalMonero feed you requested
    {'name': 'monero_standard', 'feed': 'https://localmonero.co/static/rss/the-monero-standard/full/feed.xml', 'format': 'rss2json'},
    ...
    {'name': 'twitter_monero', 'feed': 'https://nitter.privacydev.net/monero/rss', 'format': 'rss2json'}, 
